...
package com.coolGi.lod.objects;

import com.coolGi.lod.config.LodConfig;
import com.coolGi.lod.enums.DistanceGenerationMode;
import com.coolGi.lod.enums.GenerationPriority;
import com.coolGi.lod.enums.LodTemplate;
import com.coolGi.lod.enums.VerticalQuality;
import com.coolGi.lod.handlers.LodDimensionFileHandler;
		...
		if (newDimension != null && lodWorld != null)
		{
			try
			{
				...
				if (mc.hasSinglePlayerServer())
				{
					...
					ServerLevel serverWorld = LodUtil.getServerWorldFromDimension(newDimension);
