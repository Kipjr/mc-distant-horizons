...
import com.coolGi.lod.builders.bufferBuilding.LodBufferBuilder.VertexBuffersAndOffset;
import com.coolGi.lod.config.LodConfig;
import com.coolGi.lod.enums.DebugMode;
import com.coolGi.lod.enums.FogDistance;
import com.coolGi.lod.enums.FogDrawOverride;
import com.coolGi.lod.enums.FogQuality;
import com.coolGi.lod.enums.GpuUploadMethod;
import com.coolGi.lod.handlers.ReflectionHandler;
import com.coolGi.lod.objects.LodDimension;
import com.coolGi.lod.objects.NearFarFogSettings;
import com.coolGi.lod.objects.RegionPos;
import com.coolGi.lod.proxy.ClientProxy;
import com.coolGi.lod.proxy.GlProxy;
import com.coolGi.lod.util.DetailDistanceUtil;
import com.coolGi.lod.util.LevelPosUtil;
...
public class LodRenderer
{
	...
	public void drawLODs(LodDimension lodDim, PoseStack mcMatrixStack, float partialTicks, ProfilerFiller newProfiler)
	{
		//=================================//
		...
		if (LodConfig.CLIENT.advancedModOptions.debugging.debugMode.get() == DebugMode.SHOW_DETAIL_WIREFRAME)
			GL11.glPolygonMode(GL15.GL_FRONT_AND_BACK, GL15.GL_LINE);
		else
			GL11.glPolygonMode(GL15.GL_FRONT_AND_BACK, GL15.GL_FILL);
	 ...
	 */
	private Matrix4f offsetTheModelViewMatrix(PoseStack mcMatrixStack, float partialTicks)
	{
